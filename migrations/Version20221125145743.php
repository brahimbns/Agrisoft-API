 ...
 */
final class Version20221125145743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADD614C7E7 FOREIGN KEY (price_id) REFERENCES price_product (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
